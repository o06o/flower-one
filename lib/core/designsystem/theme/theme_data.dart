...
extension FlowerTextThemeDefaultExtension on FlowerTextTheme {
  ...
  TextStyle get hakgyo14Regular => hakgyoTextStyleForSize(14.0).toRegular();

  TextStyle get hakgyo12Regular => hakgyoTextStyleForSize(12.0).toRegular();
...
extension FlowerTextThemeAlias on FlowerTextTheme {
  ...
  TextStyle get main1RegularHakgyoBold => hakgyo16Regular.copyWith(fontWeight: FontWeight.bold);
